#pragma checksum "C:\Users\sandr\Desktop\Proyectos v.2\ProyBaseMuestraII\Client\Pages\Actors\EditActor.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "3621742da079980be279f7b6ee751fc11acd95ee"
// <auto-generated/>
...
#nullable disable
    ...
    public partial class EditActor : Microsoft.AspNetCore.Components.ComponentBase
    {
        ...
        {
            __builder.OpenComponent<ProyBaseMuestraII.Client.Pages.Components.FormActor>(0);
            __builder.AddAttribute(1, "ActorModel", Microsoft.AspNetCore.Components.CompilerServices.RuntimeHelpers.TypeCheck<ProyBaseMuestraII.Shared.Entity.Actor>(
#nullable restore
#line 4 "C:\Users\sandr\Desktop\Proyectos v.2\ProyBaseMuestraII\Client\Pages\Actors\EditActor.razor"
                       Actor
...
#nullable restore
#line 6 "C:\Users\sandr\Desktop\Proyectos v.2\ProyBaseMuestraII\Client\Pages\Actors\EditActor.razor"
    ...
    {
        Actor = new Actor() { Id = ActorId, ActorName = "Robert Downey Jr" };
    }

    private void Edit()
    {
        Console.WriteLine($"Id película {Actor.Id}");
        Console.WriteLine($"Actualizar nombre película {Actor.ActorName}");
