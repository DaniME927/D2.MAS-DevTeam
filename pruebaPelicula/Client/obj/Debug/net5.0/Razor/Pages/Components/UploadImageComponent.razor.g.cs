#pragma checksum "/Users/danielsanchez/Documents/GitHub/D2.MAS-DevTeam/pruebaPelicula/Client/Pages/Components/UploadImageComponent.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "def72f36b688fa1ad445718784bd1ab687a31303"
// <auto-generated/>
...
#nullable disable
    public partial class UploadImageComponent : Microsoft.AspNetCore.Components.ComponentBase
    {
        ...
        {
            __builder.AddMarkupContent(0, @"<div class=""container-upload-image"" b-u7kff1lkj8><div class=""row py-4"" b-u7kff1lkj8><div class=""col-lg-6 mx-auto"" b-u7kff1lkj8><div class=""input-group mb-3 px-2 py-2 rounded-pill bg-white shadow-sm"" b-u7kff1lkj8><input id=""upload"" type=""file"" onchange=""readURL(this);"" class=""form-control border-0"" b-u7kff1lkj8>
                <label id=""upload-label"" for=""upload"" class=""font-weight-light text-muted"" b-u7kff1lkj8>Choose file</label>
                <div class=""input-group-append"" b-u7kff1lkj8><label for=""upload"" class=""btn btn-light m-0 rounded-pill px-4"" b-u7kff1lkj8><i class=""fa fa-cloud-upload mr-2 text-muted"" b-u7kff1lkj8></i><small class=""text-uppercase font-weight-bold text-muted"" b-u7kff1lkj8>Choose file</small></label></div></div>

            
            <div class=""image-area "" b-u7kff1lkj8><img id=""imageResult"" src=""#"" alt class=""img-fluid rounded shadow-sm mx-auto d-block"" b-u7kff1lkj8></div></div></div></div>");
        }
